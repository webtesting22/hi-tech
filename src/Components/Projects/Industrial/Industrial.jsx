...
const industriallist = [
  ...
  // {
  //   src: "/images/Projects/industrial/ongoing/1-2.jpeg",
  //   title: "TORRENT POWER “B” STATION",
  //   segment: "Industrial",
  //   client: "Torrent Power Ltd",
...
const industrialcompleted = [
  {
    src: "/images/Projects/industrial/completed/17.jpg",
  ...
  {
    src: "/images/Projects/industrial/completed/1.png",
  ...
  {
    src: "/images/Projects/industrial/completed/3.png",
  ...
  {
    src: "/images/Projects/industrial/completed/4.png",
  ...
  {
    src: "/images/Projects/industrial/completed/5.png",
  ...
  {
    src: "/images/Projects/industrial/completed/6.png",
  ...
  {
    src: "/images/Projects/industrial/completed/7.png",
  ...
  {
    src: "/images/Projects/industrial/completed/2.png",
  ...
  {
    src: "/images/Projects/industrial/completed/8.png",
  ...
  {
    src: "/images/Projects/industrial/completed/9.png",
    title: "URMIN PRODUCTS PVT LTD.",
    content:
  ...
  {
    src: "/images/Projects/industrial/completed/10.png",
  ...
  {
    src: "/images/Projects/industrial/completed/11.png",
  ...
  {
    src: "/images/Projects/industrial/completed/13.png",
  ...
  {
    src: "/images/Projects/industrial/completed/14.png",
  ...
  {
    src: "/images/Projects/industrial/completed/15.png",
  ...
  {
    src: "/images/Projects/industrial/completed/16.png",
  ...
  return (
    <>
      ...
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper" slidesPerView={3}>
        ...
        {industrialcompleted.map((item, index) => {
          return (
            <SwiperSlide>
              <CardComponent key={index} image={item.src} title={item.title} client={item.client} location={item.location} projectSize={item.projectSize} projectDes={item.projectDes}
                projectYear={item.projectYear} architect={item.architect} consultant={item.consultant} scope={item.scope}
